...
interface IVideotransporterService_IVideoUpload extends grpc.MethodDefinition<s3video_pb.VideoUpoadRequest, s3video_pb.Message> {
...
export interface IVideotransporterServer {
    videoUpload: grpc.handleClientStreamingCall<s3video_pb.VideoUpoadRequest, s3video_pb.Message>;
...
export interface IVideotransporterClient {
    videoUpload(callback: (error: grpc.ServiceError | null, response: s3video_pb.Message) => void): grpc.ClientWritableStream<s3video_pb.VideoUpoadRequest>;
    videoUpload(metadata: grpc.Metadata, callback: (error: grpc.ServiceError | null, response: s3video_pb.Message) => void): grpc.ClientWritableStream<s3video_pb.VideoUpoadRequest>;
    videoUpload(options: Partial<grpc.CallOptions>, callback: (error: grpc.ServiceError | null, response: s3video_pb.Message) => void): grpc.ClientWritableStream<s3video_pb.VideoUpoadRequest>;
    videoUpload(metadata: grpc.Metadata, options: Partial<grpc.CallOptions>, callback: (error: grpc.ServiceError | null, response: s3video_pb.Message) => void): grpc.ClientWritableStream<s3video_pb.VideoUpoadRequest>;
...
export class VideotransporterClient extends grpc.Client implements IVideotransporterClient {
    ...
    public videoUpload(callback: (error: grpc.ServiceError | null, response: s3video_pb.Message) => void): grpc.ClientWritableStream<s3video_pb.VideoUpoadRequest>;
    public videoUpload(metadata: grpc.Metadata, callback: (error: grpc.ServiceError | null, response: s3video_pb.Message) => void): grpc.ClientWritableStream<s3video_pb.VideoUpoadRequest>;
    public videoUpload(options: Partial<grpc.CallOptions>, callback: (error: grpc.ServiceError | null, response: s3video_pb.Message) => void): grpc.ClientWritableStream<s3video_pb.VideoUpoadRequest>;
    public videoUpload(metadata: grpc.Metadata, options: Partial<grpc.CallOptions>, callback: (error: grpc.ServiceError | null, response: s3video_pb.Message) => void): grpc.ClientWritableStream<s3video_pb.VideoUpoadRequest>;
