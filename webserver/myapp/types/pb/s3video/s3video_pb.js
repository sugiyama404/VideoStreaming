...
goog.exportSymbol('proto.s3video.TagsObjects', null, global);
 ...
 * @constructor
 */
proto.s3video.TagsObjects = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.s3video.TagsObjects, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.s3video.TagsObjects.displayName = 'proto.s3video.TagsObjects';
}
...
proto.s3video.VideoListObjects.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    tagsobjectsList: jspb.Message.toObjectList(msg.getTagsobjectsList(),
    proto.s3video.TagsObjects.toObject, includeInstance),
...
proto.s3video.VideoListObjects.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 3:
      ...
      break;
    case 4:
      var value = new proto.s3video.TagsObjects;
      reader.readMessage(value,proto.s3video.TagsObjects.deserializeBinaryFromReader);
      msg.addTagsobjects(value);
      break;
    case 5:
      var value = /** @type {string} */ (reader.readString());
      msg.setExplain(value);
...
proto.s3video.VideoListObjects.serializeBinaryToWriter = function(message, writer) {
  ...
  f = message.getTagsobjectsList();
  if (f.length > 0) {
    writer.writeRepeatedMessage(
      4,
      f,
      proto.s3video.TagsObjects.serializeBinaryToWriter
    );
  }
  f = message.getExplain();
  if (f.length > 0) {
...
/**
 * repeated TagsObjects tagsobjects = 4;
 * @return {!Array<!proto.s3video.TagsObjects>}
 */
proto.s3video.VideoListObjects.prototype.getTagsobjectsList = function() {
  return /** @type{!Array<!proto.s3video.TagsObjects>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.s3video.TagsObjects, 4));
};


/**
 * @param {!Array<!proto.s3video.TagsObjects>} value
 * @return {!proto.s3video.VideoListObjects} returns this
*/
proto.s3video.VideoListObjects.prototype.setTagsobjectsList = function(value) {
  return jspb.Message.setRepeatedWrapperField(this, 4, value);
};


/**
 * @param {!proto.s3video.TagsObjects=} opt_value
 * @param {number=} opt_index
 * @return {!proto.s3video.TagsObjects}
 */
proto.s3video.VideoListObjects.prototype.addTagsobjects = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 4, opt_value, proto.s3video.TagsObjects, opt_index);
};
 ...
 * @return {!proto.s3video.VideoListObjects} returns this
 */
proto.s3video.VideoListObjects.prototype.clearTagsobjectsList = function() {
  return this.setTagsobjectsList([]);
};
 ...
 * @return {!Object}
 */
proto.s3video.TagsObjects.prototype.toObject = function(opt_includeInstance) {
  return proto.s3video.TagsObjects.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.s3video.TagsObjects} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.s3video.TagsObjects.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * @return {!proto.s3video.TagsObjects}
 */
proto.s3video.TagsObjects.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.s3video.TagsObjects;
  return proto.s3video.TagsObjects.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.s3video.TagsObjects} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.s3video.TagsObjects}
 */
proto.s3video.TagsObjects.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.s3video.TagsObjects.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.s3video.TagsObjects.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.s3video.TagsObjects} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.s3video.TagsObjects.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getTags();
  if (f.length > 0) {
    writer.writeString(
 ...
 * @return {string}
 */
proto.s3video.TagsObjects.prototype.getTags = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};
...
/**
 * @param {string} value
 * @return {!proto.s3video.TagsObjects} returns this
 */
proto.s3video.TagsObjects.prototype.setTags = function(value) {
  return jspb.Message.setProto3StringField(this, 1, value);
};
