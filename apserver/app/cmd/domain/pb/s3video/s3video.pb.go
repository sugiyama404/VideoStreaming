...
type VideoListObjects struct {
	...
	Tagsobjects []*TagsObjects `protobuf:"bytes,4,rep,name=tagsobjects,proto3" json:"tagsobjects,omitempty"`
...
func (x *VideoListObjects) GetTagsobjects() []*TagsObjects {
	if x != nil {
		return x.Tagsobjects
	}
	return nil
}
...
func (x *TagsObjects) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*TagsObjects) ProtoMessage() {}

func (x *TagsObjects) ProtoReflect() protoreflect.Message {
	mi := &file_cmd_domain_proto_s3video_proto_msgTypes[9]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use TagsObjects.ProtoReflect.Descriptor instead.
func (*TagsObjects) Descriptor() ([]byte, []int) {
	return file_cmd_domain_proto_s3video_proto_rawDescGZIP(), []int{9}
}

func (x *TagsObjects) GetTags() string {
	if x != nil {
		return x.Tags
	}
	return ""
...
var file_cmd_domain_proto_s3video_proto_rawDesc = []byte{
	...
	0x65, 0x6f, 0x6c, 0x69, 0x73, 0x74, 0x6f, 0x62, 0x6a, 0x65, 0x63, 0x74, 0x22, 0xa6, 0x01, 0x0a,
	...
	,
	...
	0x69, 0x73, 0x74, 0x52, 0x65, 0x70, 0x6c, 0x61, 0x79, 0x22, 0x00, 0x42, 0x0e, 0x5a, 0x0c, 0x2e,
	0x2f, 0x70, 0x62, 0x2f, 0x73, 0x33, 0x76, 0x69, 0x64, 0x65, 0x6f, 0x62, 0x06, 0x70, 0x72, 0x6f,
	0x74, 0x6f, 0x33,
}
...
var file_cmd_domain_proto_s3video_proto_msgTypes = make([]protoimpl.MessageInfo, 10)
var file_cmd_domain_proto_s3video_proto_goTypes = []interface{}{
	...
	(*TagsObjects)(nil),             // 9: s3video.TagsObjects
}
var file_cmd_domain_proto_s3video_proto_depIdxs = []int32{
	...
	9, // 1: s3video.VideoListObjects.tagsobjects:type_name -> s3video.TagsObjects
	...
	1, // 6: s3video.Videotransporter.VideoUpload:output_type -> s3video.VideoUploadReplay
	3, // 7: s3video.Videotransporter.VideoDeteilUpload:output_type -> s3video.VideoDeteilUpoadReplay
	5, // 8: s3video.Videotransporter.VideoDownload:output_type -> s3video.VideoDownloadReplay
	7, // 9: s3video.Videotransporter.VideoList:output_type -> s3video.VideoListReplay
